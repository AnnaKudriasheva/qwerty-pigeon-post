...
export default class extends Phaser.State {
    create () {
        ...
        intro = 'Oh, no! The 77th batallion Cher Ami served have trapped in' +
            ' the Argon forest behind enemy lines without food and ammunition.' +
            ' Moreover, they are starting to receive friendly fire from allied ' +
            'troops who did not know their location.\n77th batallion have' +
            ' already sent two pigeons, but all messengers were shooted, ' +
            'and now Cher Ami is their last hope to receive help.';
